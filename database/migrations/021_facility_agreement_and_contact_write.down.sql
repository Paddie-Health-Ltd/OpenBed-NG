...
-- contact's version and its trigger go, with app.bump_row_version(); the two public
-- membership bodies return to 020's, without the withdrawal predicate, and the
-- agreement's projection trigger goes (BJ-1); and app.facility_agreement goes.
--
...
--
-- The five bodies below are 020's VERBATIM, copied from that file and not retyped,
...
-- ============================================================
-- 4. The two public membership bodies, 020's verbatim, and no agreement trigger
--    (reverses R-2026-09-24-82 BJ-1). The trigger goes before the table; guarded,
--    because DROP TRIGGER names a table that a repeated down has already dropped.
-- ============================================================
DO $$
BEGIN
    IF to_regclass('app.facility_agreement') IS NOT NULL THEN
...
-- ============================================================
-- 5. The contact's version, its trigger, and the trigger function.
-- ============================================================
...
-- ============================================================
-- 6. The agreement table (empty: section 0 refused otherwise).
-- ============================================================
